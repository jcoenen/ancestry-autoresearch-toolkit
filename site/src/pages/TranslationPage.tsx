...
import { useTranslation } from '../useData'
...
export default function TranslationPage() {
  ...
  const content = useTranslation(slug || '')

  if (!content) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-center">
        <h1 className="text-2xl font-bold text-stone-800">Translation Not Found</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <nav className="text-sm text-stone-400 mb-6">
        ...
        <span className="text-stone-600">English Translation</span>
      </nav>
      <div className="mb-8">
        <span className="text-xs font-medium text-amber-700 bg-amber-50 px-2 py-1 rounded">English Translation</span>
      </div>
      <article>
